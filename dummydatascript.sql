...
(11, 'De Prins Drinkt Koffie','De Prins drinkt koffie is een trendy, hippe koffiebar aan de rand van de stad, met een ruime mogelijkheid tot parkeren.','/img/11.png',1),
(12, 'De Zwarte Kat','Sinds 1994 zijn Steven en Annick de gastheren van het restaurant, met zicht op het oudste Belfort der Nederlanden.','/img/12.png',1),
(13, 'Den Den','Café Den Den in de Sint-Janstraat, onder carnavalisten bekend als het café waar je moét geweest zijn.','/img/13.png',1),
(14, 'In ''t Filetpuurken','Midden in het centrum van Aalst bevindt zich Brasserie In''t Filetpurken. In''t Filetpurken is de ideale plaats om lekker te eten in een gezellig en warm kader.','/img/14.png',1),

(15, 'De Slegte', 'Op zoek naar een origineel boek dat niet in iedere boekwinkel in de top tien staat? Kijk dan eens bij Boekhandel De Slegte. Wij hebben een uitgebreide collectie bijzondere en voordelige boeken. Zowel in onze winkels als in de Vlaamse webwinkel. Ook kopen wij uw boeken graag in.','/img/15.png',2),
(16, 'Club', 'Boekenhandel Club is een van de weinige die er nog is. Kom zeker eens langs bij ons!', '/img/16.png', 2),
...
(23, 'Van Den Borre', 'De specialist in TV, video, hifi, elektro, multimedia en GSM in België. Gemakkelijk te vergelijken en online kopen uit een ruime keuze.','/img/23.png',4),
(24, 'Mediamarkt', 'Computer & Multimedia - Telefoon & Navigatie - Televisie & Audio - Foto & Video - Keuken - Huishouden & Verzorging - Gaming & Entertainment - ...','/img/24.png',4),
...
(28, 'CoolCat', 'Kleding in allerlei stijlen, kleuren & prints. Go get yours ? Shop nu! Snelle Levering. Gratis Ophalen in Winkels. Typen: New, Sale, Basics, Bestsellers, Party wear, Festival outfits.','/img/28.png',5),
...
(34, 'Leen Bakker', 'Mooi wonen voor lage prijzen. En altijd verrassende acties. Bezoek één van onze Leen Bakker winkels of bestel online.','/img/34.png',6),

(35, 'De Speelvogel', 'Wij bieden enkel leuk, kwalitatief en verantwoord speelgoed.','/img/35.png',7),
(36, 'Bart Smit Speelgoedwinkel', 'Het beste speelgoed vindt u in de Bart Smit.','/img/36.png',7),
...
(26, '/img/establishments/26.jpg', 45, 26, 25),
(27, '/img/establishments/27.jpg', 45, 27, 26),
